...
import { ConfigModal } from "@/features/pomodoro-timer/components/ConfigModal";
  ...
  return (
    <div className="mx-auto my-auto flex flex-col">
      ...
      <div className="flex gap-x-2">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex gap-x-4">
                    ...
                    <Button
                      variant="outline"
                      onClick={handleReset}
                      disabled={currentState !== state || !isLoaded}
        ...
        <ConfigModal pomodoroConfig={pomodoroConfig} />
      </div>
    </div>
  );
}
